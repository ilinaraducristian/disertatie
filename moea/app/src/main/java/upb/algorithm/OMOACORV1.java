...
// version 4
public class OMOACORV1 extends OMOPSO {
    ...
    public OMOACORV1(Problem problem) {
        this(
                problem,
                100,
                100,
    ...
    public OMOACORV1(Problem problem, int swarmSize, int leaderSize, double[] epsilons, double mutationProbability, double mutationPerturbation, int maxIterations, float vitezaDeConvergenta, int numarFurnici) {
